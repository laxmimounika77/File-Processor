...
<%@page import="com.advancedprogramming.fileprocessor.UploadDetail"%>
		    	...
		    	<tbody>
		    	    ...
		    	    <tr>
                     	...
                     	<td align="center"><span id="fileSize"><%=uploadDetails.get(i).getFileSize() %> KB</span></td>
                  	 	...
                  	 	<td align="center"><span id="fileDownload"><a id="downloadLink" class="hyperLink" href="/parseXml?fileName=<%=uploadDetails.get(i).getFileName() %>">Download</a></span></td>                		    	    	
		    	    </tr>
		    	    <% } %>
		    	</tbody>
		    </table>
		    <div class="margin_top_15px">
		    	<a id="fileUpload" class="hyperLink" href="/index.jsp">Back</a>
		    </div>
		</div>
	</body>
</html>